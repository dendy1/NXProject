...
namespace NXProject.Models
{
    public class Bolt : IModel
    {
        ...
        private double _headHeight; // h
        private double _headDiameter; // H
        private double _headWidth; // B
        private double _headSliceAngle = 30;

        private double _shaftLength; // L
        private double _shaftDiameter; // d
        private double _threadLength; // l

        private double _roundingRadius; // r
