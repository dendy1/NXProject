...
namespace NXProject.Models
{
    public class Nut : IModel
    {
        ...
        private void MakeHoles(SessionDrawer sessionDrawer, Point origin)
        {
            ...
            sessionDrawer.Session.Modl.AskFeatBody(oc1[0], out Tag model);
            sessionDrawer.Session.Modl.AskBodyEdges(model, out Tag[] edgeArray);
            sessionDrawer.Session.Modl.AskListItem(edgeArray, 0, out Tag champferEdge1);
            sessionDrawer.MakeChamfer(new Tag[] { champferEdge1 }, _holeChampferAngle, _holeChampferOffset);

            sessionDrawer.Session.Modl.AskListItem(edgeArray, 1, out Tag champferEdge2);
            sessionDrawer.MakeChamfer(new Tag[] { champferEdge2 }, _holeChampferAngle, _holeChampferOffset);

            sessionDrawer.Session.Modl.AskListItem(edgeArray, 2, out Tag champferEdge3);
            sessionDrawer.MakeChamfer(new Tag[] { champferEdge3 }, _holeChampferAngle, _holeChampferOffset);

            sessionDrawer.Session.Modl.AskListItem(edgeArray, 3, out Tag champferEdge4);
            sessionDrawer.MakeChamfer(new Tag[] { champferEdge4 }, _holeChampferAngle, _holeChampferOffset);
        }
